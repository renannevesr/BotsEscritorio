...
for i in range(rows):
    ...
    #consulta nome
    driver.find_element("xpath", '//*[@id="id-box-filtro"]/div/div/ul/li[3]/div/button').click()
    driver.find_element("xpath", '//*[@id="nome"]').send_keys(cpf)
    driver.find_element("xpath", '//*[@id="id-box-filtro"]/div/div/ul/li[3]/div/div/div/div[2]/input').click()
